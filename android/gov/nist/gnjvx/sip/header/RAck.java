 ...
 * 
 */
public class RAck extends SIPHeader implements android.javax.sip.header.RAckHeader {
	...
	/**
	 * @deprecated
	 * @see android.javax.sip.header.RAckHeader#setCSeqNumber(int)
	 */
	...
	/**
	 *@deprecated
	 * @see android.javax.sip.header.RAckHeader#setRSeqNumber(int)
	 */
