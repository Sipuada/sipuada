...
import android.gov.nist.gnjvx.sip.header.ims.WWWAuthenticateHeaderIms;
...
public class WWWAuthenticate
	...
	/* (non-Javadoc)
	 * @see android.gov.nist.gnjvx.sip.header.AuthenticationHeader#getURI()
	 * 
	...
	/* (non-Javadoc)
	 * @see android.gov.nist.gnjvx.sip.header.AuthenticationHeader#setURI(android.javax.sip.address.URI)
	 * 
	 * @since 1.2 this method is deprecated, uri is not a valid paramter for this header
	 * Fail silently for backwards compatibility 
	 */
