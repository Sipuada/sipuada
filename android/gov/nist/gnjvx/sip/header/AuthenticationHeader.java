...
public abstract class AuthenticationHeader extends ParametersHeader {
	 ...
	 */
	public void setURI(android.javax.sip.address.URI uri) {
		if (uri != null) {
	 ...
	 * and Proxy-Authenticate headers
	 */
	public android.javax.sip.address.URI getURI() {
	...
	/**
	 * Set the nonce count pakrameter. Bug fix sent in by Andreas Bystrom
	 */
