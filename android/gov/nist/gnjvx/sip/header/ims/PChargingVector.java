...
package android.gov.nist.gnjvx.sip.header.ims;
...
public class PChargingVector extends android.gov.nist.gnjvx.sip.header.ParametersHeader
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.gov.nist.gnjvx.sip.header.ParametersHeader#encodeBody()
	 */
	protected String encodeBody() {
		 ...
		 */		
		android.gov.nist.core.NameValue nv = getNameValue( ParameterNamesIms.ICID_VALUE );
		nv.encode( encoding );
