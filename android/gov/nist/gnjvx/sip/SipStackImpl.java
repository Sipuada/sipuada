...
import android.gov.nist.gnjvx.sip.clientauthutils.AccountManager;
import android.gov.nist.gnjvx.sip.clientauthutils.AuthenticationHelper;
import android.gov.nist.gnjvx.sip.clientauthutils.AuthenticationHelperImpl;
import android.gov.nist.gnjvx.sip.parser.StringMsgParser;
import android.gov.nist.gnjvx.sip.stack.DefaultMessageLogFactory;
import android.gov.nist.gnjvx.sip.stack.DefaultRouter;
 ...
 * explanation of these properties {@link android.javax.sip.SipStack} ). In addition to these, the
 ...
 * <ul>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.TRACE_LEVEL = integer </b><br/> You can use the standard log4j
 ...
 * for the stack is specified using the android.gov.nist.gnjvx.sip.LOG4J_LOGGER_NAME property. By default
 * log4j logger name for the stack is the same as the stack name. For example, <code>
 *	properties.setProperty("android.gov.nist.gnjvx.sip.TRACE_LEVEL", "LOG4J");
 *	properties.setProperty("android.gov.nist.gnjvx.sip.LOG4J_LOGGER_NAME", "SIPStackLogger");
 * </code>
 * allows you to now control logging in the stack entirely using log4j facilities. </li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.SERVER_LOG = fileName </b><br/> Log valid incoming messages here.
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.LOG_MESSAGE_CONTENT = true|false </b><br/> Set true if you want to
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.LOG_STACK_TRACE_ON_MESSAGE_SEND = true|false </b><br/> Set true if you want to
 * to log a stack trace at INFO level for each message send. This is really handy 
 * for debugging.</li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.DEBUG_LOG = fileName </b><br/> Where the debug log goes. <font
 * color=red> Mail this to us with bug reports. </font> </li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.MAX_MESSAGE_SIZE = integer</b> <br/> Maximum size of content that a
 ...
 * 
 * 
 * <li><b>android.gov.nist.gnjvx.sip.CACHE_SERVER_CONNECTIONS = [true|false] </b> <br/> Default value is
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.CACHE_CLIENT_CONNECTIONS = [true|false] </b> <br/> Default value is
 ...
 * 
 * <li> <b>android.gov.nist.gnjvx.sip.THREAD_POOL_SIZE = integer </b> <br/> Concurrency control for number
 ...
 * </ul>
 * 
 * <li> <b>android.gov.nist.gnjvx.sip.REENTRANT_LISTENER = true|false </b> <br/> Default is false. Set to
 ...
 * 
 * <li> <b>android.gov.nist.gnjvx.sip.MAX_CONNECTIONS = integer </b> <br/> Max number of simultaneous TCP
 * connections handled by stack. </li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.MAX_SERVER_TRANSACTIONS = integer </b> <br/> Maximum size of server
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.MAX_CLIENT_TRANSACTIONS = integer </b> <br/> Max number of active
 ...
 * </li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.PASS_INVITE_NON_2XX_ACK_TO_LISTENER = true|false </b> <br/> If true
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.MAX_LISTENER_RESPONSE_TIME = Integer </b> <br/>Max time (seconds)
 ...
 * in a memory leak.
 * 
 * <li><b>android.gov.nist.gnjvx.sip.USE_TLS_ACCELERATOR = true|false </b> <br/>Default value is false.
 ...
 * provider. </li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.DELIVER_TERMINATED_EVENT_FOR_ACK = [true|false]</b> <br/>Default is
 ...
 * 
 * <li> <b>android.gov.nist.gnjvx.sip.READ_TIMEOUT = integer </b> <br/> This is relevant for incoming TCP
 ...
 * 
 * <li> <b>android.gov.nist.gnjvx.sip.NETWORK_LAYER = classpath </b> <br/> This is an EXPERIMENTAL
 ...
 * implement android.gov.nist.core.net.NetworkLayer. The default implementation simply acts as a wrapper
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.ADDRESS_RESOLVER = classpath </b><br/> The fully qualified class
 ...
 * without doing a resolution). See android.gov.nist.gnjvx.sip.DefaultAddressResolver. </li>
 * 
 * <li><b>android.gov.nist.gnjvx.sip.AUTO_GENERATE_TIMESTAMP= [true| false] </b><br/> (default is false)
 ...
 * 
 * <li> <b>android.gov.nist.gnjvx.sip.THREAD_AUDIT_INTERVAL_IN_MILLISECS = long </b> <br/> Defines how
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.LOG_FACTORY = classpath </b> <br/> The fully qualified classpath for
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.COMPUTE_CONTENT_LENGTH_FROM_MESSAGE_BODY = [true|false] </b> <br/>
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.CANCEL_CLIENT_TRANSACTION_CHECKED = [true|false] </b> <br/> Default
 ...
 * protocol errors.
 * 
 * <li><b>android.gov.nist.gnjvx.sip.LOOSE_DIALOG_VALIDATION = [true|false] </b> <br/> Default
 ...
 * 
 * <li><b>android.gov.nist.gnjvx.sip.DELIVER_UNSOLICITED_NOTIFY = [true|false] </b> <br/> Default
 ...
 * 
 * <li><b>android.javax.net.ssl.keyStore = fileName </b> <br/> Default
 ...
 * <br><code>
 *	properties.setProperty("android.javax.net.ssl.keyStorePassword", "&lt;password&gt;");
 * </code>
 * <br>The trust store can be changed, to a separate file with the following setting:
 * <br><code>
 *	properties.setProperty("android.javax.net.ssl.trustStore", "&lt;trustStoreFileName location&gt;");
 * </code>
 ...
 * 
 */
public class SipStackImpl extends SIPTransactionStack implements android.javax.sip.SipStack, SipStackExt {
    ...
    public SipStackImpl(Properties configurationProperties) throws PeerUnavailableException {
        ...
        if (routerPath == null)
            routerPath = "android.gov.nist.gnjvx.sip.stack.DefaultRouter";
        ...
        String keyStoreFile = configurationProperties.getProperty("android.javax.net.ssl.keyStore");
        String trustStoreFile = configurationProperties.getProperty("android.javax.net.ssl.trustStore");
        if (keyStoreFile != null) {
            if (trustStoreFile == null) {
                trustStoreFile = keyStoreFile;
            }
            String keyStorePassword = configurationProperties
                    .getProperty("android.javax.net.ssl.keyStorePassword");
            try {
        ...
        super.isAutomaticDialogSupportEnabled = configurationProperties.getProperty(
                "android.javax.sip.AUTOMATIC_DIALOG_SUPPORT", "on").equalsIgnoreCase("on");
        
        super.looseDialogValidation = configurationProperties.getProperty(
                "android.gov.nist.gnjvx.sip.LOOSE_DIALOG_VALIDATION", "false").equalsIgnoreCase("true");

        if (configurationProperties.getProperty("android.gov.nist.gnjvx.sip.MAX_LISTENER_RESPONSE_TIME") != null) {
            super.maxListenerResponseTime = Integer.parseInt(configurationProperties
                    .getProperty("android.gov.nist.gnjvx.sip.MAX_LISTENER_RESPONSE_TIME"));
            if (super.maxListenerResponseTime <= 0)
                throw new PeerUnavailableException(
                        "Bad configuration parameter android.gov.nist.gnjvx.sip.MAX_LISTENER_RESPONSE_TIME : should be positive");
        } else {
        ...
        String useTlsAcceleratorFlag = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.USE_TLS_ACCELERATOR");
        ...
        this.deliverTerminatedEventForAck = configurationProperties.getProperty(
                "android.gov.nist.gnjvx.sip.DELIVER_TERMINATED_EVENT_FOR_ACK", "false").equalsIgnoreCase(
                "true");

        this.deliverUnsolicitedNotify = configurationProperties.getProperty(
                "android.gov.nist.gnjvx.sip.DELIVER_UNSOLICITED_NOTIFY", "false")
        ...
        final String NETWORK_LAYER_KEY = "android.gov.nist.gnjvx.sip.NETWORK_LAYER";
        ...
        final String ADDRESS_RESOLVER_KEY = "android.gov.nist.gnjvx.sip.ADDRESS_RESOLVER";
        ...
        String maxConnections = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.MAX_CONNECTIONS");
        ...
        String serverTransactionTableSize = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.MAX_SERVER_TRANSACTIONS");
        ...
        String clientTransactionTableSize = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.MAX_CLIENT_TRANSACTIONS");
        ...
        String readTimeout = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.READ_TIMEOUT");
        if (readTimeout != null) {
            try {
        ...
        String interval = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.THREAD_AUDIT_INTERVAL_IN_MILLISECS");
        if (interval != null) {
            try {
        ...
        this.setNon2XXAckPassedToListener(Boolean.valueOf(
                configurationProperties.getProperty(
                        "android.gov.nist.gnjvx.sip.PASS_INVITE_NON_2XX_ACK_TO_LISTENER", "false"))
                .booleanValue());

        this.generateTimeStampHeader = Boolean.valueOf(
                configurationProperties.getProperty("android.gov.nist.gnjvx.sip.AUTO_GENERATE_TIMESTAMP",
                        "false")).booleanValue();

        String messageLogFactoryClasspath = configurationProperties
                .getProperty("android.gov.nist.gnjvx.sip.LOG_FACTORY");
        ...
        boolean computeContentLength = configurationProperties.getProperty(
                "android.gov.nist.gnjvx.sip.COMPUTE_CONTENT_LENGTH_FROM_MESSAGE_BODY", "false")
                .equalsIgnoreCase("true");
        ...
        super.rfc2543Supported = configurationProperties.getProperty(
                "android.gov.nist.gnjvx.sip.RFC_2543_SUPPORT_ENABLED", "true").equalsIgnoreCase("true");

        super.cancelClientTransactionChecked = configurationProperties.getProperty(
                "android.gov.nist.gnjvx.sip.CANCEL_CLIENT_TRANSACTION_CHECKED", "true").equalsIgnoreCase(
                "true");
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.SipStack#createListeningPoint(java.lang.String, int, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.gov.nist.gnjvx.sip.SipStackExt#getAuthenticationHelper(android.gov.nist.gnjvx.sip.clientauthutils.AccountManager,
     *      android.javax.sip.header.HeaderFactory)
     */
