 ...
 *
 */
public class AddressFactoryImpl implements android.javax.sip.address.AddressFactory {
	...
	public android.javax.sip.address.Address createAddress() {
	...
	public android.javax.sip.address.Address createAddress(
		String displayName,
		android.javax.sip.address.URI uri) {
		if (uri == null)
	 ...
	 */
	public android.javax.sip.address.SipURI createSipURI(String uri)
	 ...
	 *@param host -- the host.
	 */
	public android.javax.sip.address.SipURI createSipURI(String user, String host)
		throws ParseException {
		if (host == null)
	 ...
	 */
	public android.javax.sip.address.TelURL createTelURL(String uri)
		throws ParseException {
		if (uri == null)
	...
	public android.javax.sip.address.Address createAddress(android.javax.sip.address.URI uri) {
		if (uri == null)
	 ...
	 */
	public android.javax.sip.address.Address createAddress(String address)
	...
	public android.javax.sip.address.URI createURI(String uri) throws ParseException {
		if (uri == null)
		...
		try {
			...
			if (scheme.equalsIgnoreCase("sip")) {
				return (android.javax.sip.address.URI) urlParser.sipURL();
			} else if (scheme.equalsIgnoreCase("sips")) {
				return (android.javax.sip.address.URI) urlParser.sipURL();
			} else if (scheme.equalsIgnoreCase("tel")) {
				return (android.javax.sip.address.URI) urlParser.telURL();
			}
		} catch (ParseException ex) {
			throw new ParseException(ex.getMessage(), 0);
		}
		return new android.gov.nist.gnjvx.sip.address.GenericURI(uri);
	}
