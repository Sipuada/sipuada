...
public class ServerLog {
	...
	private void setProperties(Properties configurationProperties) {
		...
		this.logFileName = configurationProperties.getProperty("android.gov.nist.gnjvx.sip.SERVER_LOG");
		String logLevel = configurationProperties.getProperty("android.gov.nist.gnjvx.sip.TRACE_LEVEL");
		String logContent = configurationProperties
				.getProperty("android.gov.nist.gnjvx.sip.LOG_MESSAGE_CONTENT");
			...
			if (printWriter == null) {
				boolean overwrite = Boolean.valueOf(
					configurationProperties.getProperty(
						"android.gov.nist.gnjvx.sip.SERVER_LOG_OVERWRITE"));
