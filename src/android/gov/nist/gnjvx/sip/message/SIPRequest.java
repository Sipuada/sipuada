...
public final class SIPRequest extends SIPMessage implements android.javax.sip.message.Request {
     ...
     */
    public android.javax.sip.address.URI getRequestURI() {
        if (this.requestLine == null)
            return null;
        else
            return (android.javax.sip.address.URI) this.requestLine.getUri();
    }
