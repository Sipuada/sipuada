 ...
 ******************************************************************************/
package android.gov.nist.gnjvx.sip.message;

import android.gov.nist.core.InternalErrorHandler;
import android.gov.nist.gnjvx.sip.SIPConstants;
import android.gov.nist.gnjvx.sip.header.AlertInfo;
import android.gov.nist.gnjvx.sip.header.Authorization;
import android.gov.nist.gnjvx.sip.header.CSeq;
import android.gov.nist.gnjvx.sip.header.CallID;
import android.gov.nist.gnjvx.sip.header.Contact;
import android.gov.nist.gnjvx.sip.header.ContactList;
import android.gov.nist.gnjvx.sip.header.ContentLength;
import android.gov.nist.gnjvx.sip.header.ContentType;
import android.gov.nist.gnjvx.sip.header.ErrorInfo;
import android.gov.nist.gnjvx.sip.header.ErrorInfoList;
import android.gov.nist.gnjvx.sip.header.From;
import android.gov.nist.gnjvx.sip.header.InReplyTo;
import android.gov.nist.gnjvx.sip.header.MaxForwards;
import android.gov.nist.gnjvx.sip.header.Priority;
import android.gov.nist.gnjvx.sip.header.ProxyAuthenticate;
import android.gov.nist.gnjvx.sip.header.ProxyAuthorization;
import android.gov.nist.gnjvx.sip.header.ProxyRequire;
import android.gov.nist.gnjvx.sip.header.ProxyRequireList;
import android.gov.nist.gnjvx.sip.header.RSeq;
import android.gov.nist.gnjvx.sip.header.RecordRouteList;
import android.gov.nist.gnjvx.sip.header.RetryAfter;
import android.gov.nist.gnjvx.sip.header.Route;
import android.gov.nist.gnjvx.sip.header.RouteList;
import android.gov.nist.gnjvx.sip.header.SIPETag;
import android.gov.nist.gnjvx.sip.header.SIPHeader;
import android.gov.nist.gnjvx.sip.header.SIPHeaderList;
import android.gov.nist.gnjvx.sip.header.SIPHeaderNamesCache;
import android.gov.nist.gnjvx.sip.header.SIPIfMatch;
import android.gov.nist.gnjvx.sip.header.Server;
import android.gov.nist.gnjvx.sip.header.Subject;
import android.gov.nist.gnjvx.sip.header.To;
import android.gov.nist.gnjvx.sip.header.Unsupported;
import android.gov.nist.gnjvx.sip.header.UserAgent;
import android.gov.nist.gnjvx.sip.header.Via;
import android.gov.nist.gnjvx.sip.header.ViaList;
import android.gov.nist.gnjvx.sip.header.WWWAuthenticate;
import android.gov.nist.gnjvx.sip.header.Warning;
import android.gov.nist.gnjvx.sip.parser.HeaderParser;
import android.gov.nist.gnjvx.sip.parser.ParserFactory;
...
public abstract class SIPMessage extends MessageObject implements
		android.javax.sip.message.Message, MessageExt {
