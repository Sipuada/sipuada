...
import android.gov.nist.gnjvx.sip.header.Event;
import android.gov.nist.gnjvx.sip.header.ReferTo;
...
import android.gov.nist.gnjvx.sip.message.MessageFactoryImpl;
...
import android.gov.nist.gnjvx.sip.stack.ServerRequestInterface;
import android.gov.nist.gnjvx.sip.stack.ServerResponseInterface;
...
class DialogFilter implements ServerRequestInterface, ServerResponseInterface {
        ...
        if (dialog == null && sipRequest.getMethod().equals(Request.NOTIFY)) {
            ...
            if (sipProvider.isAutomaticDialogSupportEnabled() && pendingSubscribeClientTx == null
                ...
                try {
                	...
                	System.out.println("Exception while sending error response statelessly");
                	ex.printStackTrace();
                    return;
                }
    ...
    public void processResponse(SIPResponse response, MessageChannel incomingMessageChannel,
                ...
                if (response.getStatusCode() / 100 != 2) {
                    ...
                    if (ackAlreadySent
                        ...
                        try {
                        	...
                        	System.out.println("could not resend ack");
                        	ex.printStackTrace();
                        }
                    }
                }
        ...
        responseEvent = new android.javax.sip.ResponseEvent(sipProvider, (ClientTransaction) transaction,
    ...
    public void processResponse(SIPResponse sipResponse, MessageChannel incomingChannel) {
        ...
        ResponseEvent responseEvent = new android.javax.sip.ResponseEvent(sipProvider,
