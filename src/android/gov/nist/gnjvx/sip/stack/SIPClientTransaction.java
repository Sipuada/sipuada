...
import android.gov.nist.gnjvx.sip.header.RecordRoute;
...
import android.gov.nist.gnjvx.sip.header.TimeStamp;
...
public class SIPClientTransaction extends SIPTransaction implements ServerResponseInterface,
        android.javax.sip.ClientTransaction, android.gov.nist.gnjvx.sip.ClientTransactionExt {
        ...
        if (TransactionState.TERMINATED == this.getState()) {
            ...
            if (statusCode / 100 == 2) {
                ...
                try {
                	...
                	System.out.println("Unexpected Exception sending ACK -- sending error ACK");
                	ex.printStackTrace();
                }
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.ClientTransaction#sendRequest()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.ClientTransaction#createCancel()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.ClientTransaction#createAck()
     */
    public Request createAck() throws SipException {
        ...
        if (recordRouteList == null) {
            ...
            if (lastResponse.getContactHeaders() != null
                ...
                android.javax.sip.address.URI uri = (android.javax.sip.address.URI) contact.getAddress().getURI()
                        .clone();
        ...
        if (!((SipURI) ((Route) routeList.getFirst()).getAddress().getURI()).hasLrParam()) {
            ...
            android.javax.sip.address.URI uri = firstRoute.getAddress().getURI();
            ackRequest.setRequestURI(uri);
     ...
     * (non-Javadoc)
     * 
     * @see android.gov.nist.gnjvx.sip.stack.ServerResponseInterface#processResponse(android.gov.nist.gnjvx.sip.message.SIPResponse,
     *      android.gov.nist.gnjvx.sip.stack.MessageChannel)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.gov.nist.gnjvx.sip.stack.SIPTransaction#getDialog()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.gov.nist.gnjvx.sip.stack.SIPTransaction#setDialog(android.gov.nist.gnjvx.sip.stack.SIPDialog,
     *      android.gov.nist.gnjvx.sip.message.SIPMessage)
     */
