...
import android.gov.nist.gnjvx.sip.ServerTransactionExt;
import android.gov.nist.gnjvx.sip.SipProviderImpl;
import android.gov.nist.gnjvx.sip.Utils;
import android.gov.nist.gnjvx.sip.header.Expires;
import android.gov.nist.gnjvx.sip.header.ParameterNames;
...
public class SIPServerTransaction extends SIPTransaction implements ServerRequestInterface,
        android.javax.sip.ServerTransaction, ServerTransactionExt {
        ...
        protected void runTask() {
            ...
            if (realState == null || TransactionState.TRYING == realState) {
                try {
                	...
                	System.out.println("IO error sending  TRYING");
                	ex.printStackTrace();
                }
            }
