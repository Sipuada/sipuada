...
public class SIPDialog implements android.javax.sip.Dialog, DialogExt {
    ...
    private android.javax.sip.address.Address localParty;

    private android.javax.sip.address.Address remoteParty;
    ...
    /*
     * @see android.javax.sip.Dialog#setApplicationData()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getApplicationData()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getLocalSequenceNumberLong()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getRemoteSequenceNumberLong()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getLocalTag()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getRemoteTag()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#delete()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getCallId()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getLocalParty()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getRemoteTarget()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#getState()
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#sendAck(android.javax.sip.message.Request)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#createRequest(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#sendRequest(android.javax.sip.ClientTransaction)
     */
     ...
     * 
     * @see android.javax.sip.Dialog#createPrack(android.javax.sip.message.Response)
     */
     ...
     * 
     * @see android.javax.sip.Dialog#createAck(long)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#createReliableProvisionalResponse(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#sendReliableProvisionalResponse(android.javax.sip.message.Response)
     */
     ...
     * (non-Javadoc)
     * 
     * @see android.javax.sip.Dialog#terminateOnBye(boolean)
     */
