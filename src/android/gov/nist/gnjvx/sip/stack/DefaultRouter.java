 ...
 * 
 * <p>
 * When <code>android.javax.sip.USE_ROUTER_FOR_ALL_URIS</code> is set to
 ...
 * <li> Else, if the property <code>android.javax.sip.OUTBOUND_PROXY</code> is set,
 * use its value as the next hop
 * <li> Otherwise, use the request URI as next hop. If the request URI is not a
 * SIP URI, call {@link android.javax.sip.address.Router#getNextHop(Request)} provided
 * by the application.
 * </ul>
 * 
 * <p>
...
public class DefaultRouter implements Router {
	...
	public DefaultRouter(SipStack sipStack, String defaultRoute) {
		...
		if (defaultRoute != null) {
			try {
				...
				System.out.println("Invalid default route specification - need host:port/transport");
				throw ex;
			}
		}
	}
	...
	public Hop getNextHop(Request request) throws SipException {
		...
		android.javax.sip.address.URI requestURI = requestLine.getUri();
		if (requestURI == null)
		...
		if (routes != null) {
			...
			return createHop((SipURI) requestURI,request);
		} else {
	...
	public android.javax.sip.address.Hop getOutboundProxy() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.javax.sip.address.Router#getNextHop(android.javax.sip.message.Request)
	 */
