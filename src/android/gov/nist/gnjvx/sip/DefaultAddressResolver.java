 ...
 * @version 1.2
 * @since 1.2
 * @see android.gov.nist.gnjvx.sip.SipStackImpl#setAddressResolver(AddressResolver)
 * 
...
public class DefaultAddressResolver implements AddressResolver {
	...
	/*
	 * (non-Javadoc)
	 * @see android.gov.nist.core.net.AddressResolver#resolveAddress(android.javax.sip.address.Hop)
	 */
