...
import android.gov.nist.gnjvx.sip.header.ims.*;	/* IMS headers - issued by Miguel Freitas */
import android.gov.nist.gnjvx.sip.header.extensions.*; // extension headers - pmusgrave
...
public class HeaderFactoryImpl implements HeaderFactory , HeaderFactoryExt {
	...
	*/
	 ...
	 */
	public android.javax.sip.header.ExtensionHeader createExtensionHeader(
		String name,
		String value)
		throws ParseException {
		if (name == null)
		...
		android.gov.nist.gnjvx.sip.header.ExtensionHeaderImpl ext =
			new android.gov.nist.gnjvx.sip.header.ExtensionHeaderImpl();
		ext.setName(name);
		ext.setValue(value);
	...
	*/
	...
	public MimeVersionHeader createMimeVersionHeader(
		...
		if (majorVersion < 0 || minorVersion < 0)
			throw new android.javax.sip.InvalidArgumentException(
	...
	/**
	 * @deprecated
	 * @see android.javax.sip.header.HeaderFactory#createRAckHeader(int, int, java.lang.String)
	 */
	...
	/**
	 * @deprecated
	 * @see android.javax.sip.header.HeaderFactory#createRSeqHeader(int)
	 */
	...
	*/
	 ...
	 */
	public android.javax.sip.header.Header createHeader(
		String headerName,
		String headerValue)
	...
	/*
	 * (non-Javadoc)
	 * @see android.javax.sip.header.HeaderFactory#createSIPETagHeader(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see android.javax.sip.header.HeaderFactory#createSIPIfMatchHeader(java.lang.String)
	 */
