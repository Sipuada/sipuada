...
import android.gov.nist.javax.sip.header.ims.*; /* IMS headers - issued by Miguel Freitas */
import android.gov.nist.javax.sip.header.extensions.*; // extension headers - pmusgrave
import android.javax.sip.header.*;

import android.gov.nist.javax.sip.parser.*;
...
public class HeaderFactoryImpl implements HeaderFactory , HeaderFactoryExt {
    ...
    */
    ...
    public android.javax.sip.header.ExtensionHeader createExtensionHeader(
        ...
        android.gov.nist.javax.sip.header.ExtensionHeaderImpl ext =
            new android.gov.nist.javax.sip.header.ExtensionHeaderImpl();
        ext.setName(name);
        ext.setValue(value);
    ...
    */
     ...
     * @throws ParseException 
     */
    public android.javax.sip.header.Header createHeader(String headerText) throws ParseException {
