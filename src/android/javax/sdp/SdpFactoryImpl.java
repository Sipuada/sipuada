 ...
 *
 */
public class SdpFactoryImpl extends Object {
	private static final SdpFactoryImpl singletonInstance = new SdpFactoryImpl();

	/** Creates new SdpFactory */
	private SdpFactoryImpl() {
	}
	 ...
	 */
	public static SdpFactoryImpl getInstance() {
	...
	public SessionDescription createSessionDescription(String localHost) throws SdpException {
		SessionDescriptionImpl sessionDescriptionImpl = new SessionDescriptionImpl();
	 ...
	 */
	public SessionDescription createSessionDescriptionFromString(String s)
			throws SdpParseException {
		try {
	 ...
	 * @return URI
	 */
	public android.javax.sdp.URI createURI(URL value) throws SdpException {
	...
	public static void main(String[] args) throws SdpParseException,
		...
		SdpFactoryImpl sdpFactory = new SdpFactoryImpl();
